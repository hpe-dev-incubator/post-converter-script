...
```![Curl command to retrieve the version of the  API.](/uploads/media/2017/9/curl-1-1504806712277.png)
# Parsing JSON 
...
```![command line JSON processor to parse the JSON](/uploads/media/2017/9/curl-2-1504806725594.png)
...
```![Retrieve API version using command line JSON parser](/uploads/media/2017/9/curl-3-1504806732409.png)
...
echo $currentVersion
```![retrieve current version of API using open source jq tool](/uploads/media/2017/9/curl-4-1504806739646.png)
...
```![Getting a Session token using POST Curl command](/uploads/media/2017/9/curl-5-1504806745891.png)
...
echo $sessionID
```![extract the sessionID in a variable](/uploads/media/2017/9/curl-6-1504806754438.png)
...
| jq -r ".members\[\].model"
```![enumerate the models of the servers managed in this environment](/uploads/media/2017/9/curl-7-1504806761092.png)
...
jq -r ".sessionID"
```![Curl command to retrieve a sessionID using jq tool](/uploads/media/2017/9/curl-8-1504806767303.png)
...
echo %sessionID%![store session id into a variable in Windows command interpreter](/uploads/media/2017/9/curl-9-1504806773156.png)
...
the same GET from cURL in a script![POSTman can help to generate Curl code](/uploads/media/2017/9/curl-10-1504806780133.png)
...
your own script.![Generated Curl code from POSTman REST tool](/uploads/media/2017/9/curl-11-1504806788067.png)
# What is next?
